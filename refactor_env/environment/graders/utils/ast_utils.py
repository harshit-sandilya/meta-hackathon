...
class FunctionInfo:
    ...
    node: Optional[ast.FunctionDef] = field(default=None, compare=False, repr=False)
...
class ClassInfo:
    ...
    has_docstring: bool
    method_count: int
    node: Optional[ast.ClassDef] = field(default=None, compare=False, repr=False)
...
def parse_file_safe(path: Path) -> Optional[ast.Module]:
    """
